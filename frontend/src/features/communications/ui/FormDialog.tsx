...
const COMM_TYPES: { value: CommunicationType; label: string }[] = [
  ...
  { value: "DOE", label: "DOE" },
  { value: "SCFRB", label: "SCFRB" },
  { value: "BAC", label: "BAC (Bids and Awards Committee)" },
  { value: "HRMO", label: "HRMO" },
  { value: "MAYOR_OFFICE", label: "Mayor's Office" },
  { value: "VICE_MAYOR_OFFICE", label: "Vice Mayor's Office" },
  { value: "ACCOUNTING", label: "Accounting Office" },
  { value: "BUDGET", label: "Budget Office" },
  { value: "TREASURY", label: "Treasury Office" },
  { value: "ENGINEERING", label: "Engineering Office" },
  { value: "COMELEC", label: "COMELEC-related" },
  { value: "DILG", label: "DILG" },
  { value: "COA", label: "COA" },
  { value: "LETTER_REQUEST", label: "Letter Request" },
  { value: "LETTER_REPLY", label: "Letter Reply" },
