...
const COMMUNICATION_TYPES: FilterOption[] = [
  ...
  { id: "NOTICE_HEARING", name: "NOTICE_HEARING", label: "Notice of Hearing" },
  ...
  { id: "SCFRB", name: "SCFRB", label: "SCFRB" },
  { id: "BAC", name: "BAC", label: "BAC (Bids and Awards Committee)" },
  { id: "HRMO", name: "HRMO", label: "HRMO" },
  { id: "MAYOR_OFFICE", name: "MAYOR_OFFICE", label: "Mayor's Office" },
  { id: "VICE_MAYOR_OFFICE", name: "VICE_MAYOR_OFFICE", label: "Vice Mayor's Office" },
  { id: "ACCOUNTING", name: "ACCOUNTING", label: "Accounting Office" },
  { id: "BUDGET", name: "BUDGET", label: "Budget Office" },
  { id: "TREASURY", name: "TREASURY", label: "Treasury Office" },
  { id: "ENGINEERING", name: "ENGINEERING", label: "Engineering Office" },
  { id: "COMELEC", name: "COMELEC", label: "COMELEC-related" },
  { id: "DILG", name: "DILG", label: "DILG" },
  { id: "COA", name: "COA", label: "COA" },
  { id: "LETTER_REQUEST", name: "LETTER_REQUEST", label: "Letter Request" },
  { id: "LETTER_REPLY", name: "LETTER_REPLY", label: "Letter Reply" },
  { id: "COMPLAINT", name: "COMPLAINT", label: "Complaint" },
  { id: "REPORT", name: "REPORT", label: "Report" },
  { id: "CERTIFICATION", name: "CERTIFICATION", label: "Certification" },
